...
public class LinkedListTTester_09_03 {
	...
	public enum Menu {
		ADD_FIRST("머리에 노드를 삽입 "), ADD_LAST("꼬리에 노드를 삽입 "), RMV_FIRST("머리 노드를 삭제"), RMV_LAST("꼬리 노드를 삭제"), RMV_CRNT(
				"선택 노드를 삭제"), CLEAR("모든 노드를 삭제"), SEARCH_NO("번호로 검색"), SEARCH_NAME("이름으로 검색"), NEXT(
						"선택 노드로 이동"), PRINT_CRNT("선택 노드를 출력"), PURGE_NO("같은 번호의 노드를 삭제"), PURGE_NAME(
	...
	public static void main(String[] args) {
		...
		LinkedListT_09_03<Data> list = new LinkedListT_09_03<Data>(); // 리스트를 생성
